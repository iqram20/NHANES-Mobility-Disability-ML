...
SUBGROUP_DIR = RUN_DIR / "subgroup_analysis"
...
def remove_xport_tiny_artifacts(
    dataframe: pd.DataFrame,
) -> pd.DataFrame:
    output = dataframe.copy()
...
def load_table1_cohort() -> pd.DataFrame:
    ...
    cohort = remove_xport_tiny_artifacts(
        cohort
    )
